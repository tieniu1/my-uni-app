...
VantComponent({
    ...
    methods: {
        ...
        // get column instance by picker
        getColumn(index) {
            return this.children[index];
        },
        // get column value by picker
        getColumnValue(index) {
            const column = this.getColumn(index);
            return column && column.getValue();
        },
        // set column value by picker
        ...
        // get column option picker by column picker
        getColumnIndex(columnIndex) {
            return (this.getColumn(columnIndex) || {}).data.currentIndex;
        },
        // set column option picker by column picker
        ...
        // get options of column by picker
        getColumnValues(index) {
            return (this.children[index] || {}).data.options;
        },
        // set options of column by picker
