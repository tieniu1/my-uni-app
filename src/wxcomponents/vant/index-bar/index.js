...
VantComponent({
    relation: useChildren('picker-anchor', function () {
        this.updateData();
    }),
    props: {
        sticky: {
    ...
    methods: {
        ...
        setAnchorsRect() {
            return Promise.all(this.children.map((anchor) => getRect(anchor, '.van-picker-anchor-wrapper').then((rect) => {
        ...
        setListRect() {
            return getRect(this, '.van-picker-bar').then((rect) => {
                if (!isDef(rect)) {
                    return;
                }
                Object.assign(this, {
        ...
        setSiderbarRect() {
            return getRect(this, '.van-picker-bar__sidebar').then((res) => {
                if (!isDef(res)) {
                    return;
                }
                this.sidebar = {
        ...
        getAnchorRect(anchor) {
            return getRect(anchor, '.van-picker-anchor-wrapper').then((rect) => ({
                height: rect.height,
                top: rect.top,
            }));
        },
